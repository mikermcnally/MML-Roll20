...
MML.unarmedAttacks["Punch, Plate"] = {family: "Unarmed", initiative: 10, task: 25, defenseMod: 15, damage: "1d6", damageType: "Impact"};
MML.unarmedAttacks["Kick"] = {family: "Unarmed", initiative: 10, task: 15, defenseMod: 15, damage: "1d4", damageType: "Impact"};
MML.unarmedAttacks["Kick, Heavy Boots"] = {family: "Unarmed", initiative: 10, task: 15, defenseMod: 15, damage: "1d6", damageType: "Impact"};
...
MML.charMenuAttack = function charMenuAttack(input) {
    ...
    if (!_.has(character.statusEffects, "Grappled") || !_.has(character.statusEffects, "Holding")) {
        buttons.push({
            text: "Grapple",
    ...
    if (_.has(character.statusEffects, "Holding")) {
        buttons.push({
            ...
            nextMenu: "charMenuAttackStance",
            callback: function(input) {
                state.MML.characters[this.who].action.weaponType = "Release a Hold";
                MML.processCommand({
                    type: "player",
                    who: this.name,
                    callback: "displayMenu",
...
MML.charMenuAttackStance = function charMenuAttackStance(input) {
    ...
    if (["Punch", "Kick", "Head Butt", "Bite", "Grapple", "Place a Hold", "Break a Hold", "Release a Hold"].indexOf(character.action.weaponType) > -1) {
        _.each(buttons, function(button) {
            button.nextMenu = "charMenuFinalizeAction";
        });
