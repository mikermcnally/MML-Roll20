...
declare global {
  ...
  function createObj(type: Roll20.ObjectType, attributes: object): IObject;
    // Roll20.IAbility |
    // Roll20.IAttribute |
    // Roll20.ICharacter |
    // Roll20.ICard |
  ...
  function filterObjs(callback: (obj: Roll20.IObject) => boolean): IObject;
  ...
  function findObjs(attrs: object, options?: object): Array<IObject>;
    // Array<Roll20.IAbility> |
    // Array<Roll20.IAttribute> |
    // Array<Roll20.ICharacter> |
    // Array<Roll20.ICard> |
  ...
  function getObj(type: Roll20.ObjectType, id: Roll20.Id): IObject;
    // Roll20.IAbility |
    // Roll20.IAttribute |
    // Roll20.ICharacter |
    // Roll20.ICard |
  ...
  function on(event: Roll20.Event, callback: (any) => void): void;
  ...
  function sendChat(speaking_as: string, message: string, callback?: (messages: Array<Roll20.IChatMessage>) => void, options?: { noarchive?: boolean, use3d?: boolean }): void;
